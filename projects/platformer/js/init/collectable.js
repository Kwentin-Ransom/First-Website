(function (window) {
    ...
    collectable.init = function (game) {
        ...
        // example: 
        collectable.create(type.steve, 200, 170, 6, 0.7);        //collectable 1
        collectable.create(type.grace, 830, 600, 10, 1);         //cpllectable 2 
        collectable.create(type.kennedi, 770, 140, 10, 1);       //collectable 3
